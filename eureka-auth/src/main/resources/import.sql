...
insert into accommodation (id_agent, accomodation_type_id, description, category, location_id, accommodation_id, capacity, name, canceling_period, status) values (3, 1, 'desc', 1, 1, 2, 3, 'name1', 3, 0);
